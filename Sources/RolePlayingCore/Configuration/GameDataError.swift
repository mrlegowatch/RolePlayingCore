...
public enum GameDataError: Error, Sendable {
...
/// Returns a missingFile GameDataError with the specified message.
...
public func missingFileError(_ fileName: String, _ bundlePath: String, source: String = #function, file: String = #file, line: Int = #line) -> Error {
    return GameDataError.missingFile(fileName, bundlePath, "Thrown in \(source) (File: \(file) Line: \(line))")
}

/// Returns a badJSON GameDataError with the specified message.
/// The source function, file and line are recorded in location.
public func missingJSONError(_ name: String, source: String = #function, file: String = #file, line: Int = #line) -> Error {
    return GameDataError.missingJSON(name, "Thrown in \(source) (File: \(file) Line: \(line))")
}

/// Returns a missingType GameDataError with the specified message.
/// The source function, file and line are recorded in location.
public func missingTypeError(_ kind: String, _ name: String, source: String = #function, file: String = #file, line: Int = #line) -> Error {
    return GameDataError.missingType(kind, name, "Thrown in \(source) (File: \(file) Line: \(line))")
}

extension GameDataError: CustomStringConvertible {
